...
| --- | --- | --- | --- |
| ⚡ Energía    | [Balance Neto](https://github.com/MiguelAngelLV/balance_neto) | Cálculo del Balance Neto Horario para instalaciones fotovoltáicas. || 
...
| 🌥️ Meteo      | [Catalunya Beaches](https://github.com/tamaygz/ha-catalunya-beaches) | Monitor Catalan beaches with real-time water quality, weather conditions, and safety information from the Catalan Water Agency (Agència Catalana de l'Aigua). | | 🌥️ Meteo      | [Mareas Meteogalicia](https://github.com/Danieldiazi/homeassistant-meteogalicia_tides) | A Home Assistant integration that gives you tides info from MeteoGalicia, the meteorological agency for Galicia, Spain ||
